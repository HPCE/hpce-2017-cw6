...
ftab_Table *ftab_CreateTable (int Nr, int j1, int j2, int jstep,
                              const char *Desc, ftab_FormType Form, int Ns);
...
void ftab_SetDesc (ftab_Table *T, const char *Desc);
...
extern const ftab_StyleType ftab_Style;



extern const double ftab_Suspectp;



extern const int ftab_SuspectLog2p;
