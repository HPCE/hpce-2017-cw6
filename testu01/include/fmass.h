...
extern const double fmass_Epsilon;


extern const double fmass_MaxLambdaPoisson;  /* = 100000  */

extern const double fmass_MaxnBinomial;      /* = 100000  */

extern const double fmass_MaxnNegaBin;       /* = 100000  */
