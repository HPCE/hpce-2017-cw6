...
/* SAGE */ static std::atomic_flag co1 = ATOMIC_FLAG_INIT, co2 = ATOMIC_FLAG_INIT, co3 = ATOMIC_FLAG_INIT, co4 = ATOMIC_FLAG_INIT;      /* Counters */
...
void ran_array1(long *aa,int n)    /* put n new random numbers in aa */
/* long *aa;    destination */
...
void ranf_array1(double *aa,int n)    /* put n new random fractions in aa */
...
{
  if (NULL == gen) // || co1 == 0)  DT10 : Don't understand second clause
      return;
